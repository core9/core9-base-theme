...
Core9.menu = {
		...
		menu : function(){
			...
			menu += '<li><button style="border: 0 rgba(0,0,0,0); background-color: transparent; width: 125px; text-decoration: none; color:#000; text-align:left;"  onclick="if (\'parentIFrame\' in window) window.parentIFrame.sendMessage(\'edit-block\');return false;">Edit</button></li>';
		...
		setContextMenu :	function () {
			...
			var contextMenuElements = document.getElementsByClassName('block'); // class for context menu
